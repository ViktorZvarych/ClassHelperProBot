...
async def calculate_duty_students(target_date, pool):
    """Розрахунок чергових для вечірнього cron (без блокування рядків)."""
...
async def calculate_duty_students_with_lock(target_date, pool):
    """Розрахунок чергових для ранкового cron (з блокуванням рядків)."""
    async with pool.acquire() as conn:
